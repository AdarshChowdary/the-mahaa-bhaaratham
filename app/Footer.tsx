export default function Footer () {
    ...
    return (
        <footer 
            className="w-full bg-custom-navy py-6 px-4"
            role="contentinfo"
            aria-label="Site footer"
            data-section="footer"
        >
            <div className="max-w-4xl mx-auto flex flex-col justify-between items-center gap-4">
                <p 
                    className="text-custom-mint text-base sm:text-lg"
                    data-content="copyright"
                >
                    &copy; {currentYear} The Fifth Veda. All rights reserved.
                </p>
                <div 
                ...
                >
                    <a
                        ...
                        className="flex items-center text-sm sm:text-base gap-2 text-custom-sky-blue hover:text-custom-mint transition duration-200"
